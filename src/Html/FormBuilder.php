<?php namespace Mrtom90\LaravelShop\Html;
...
class FormBuilder
{
     ...
     *
     * @var \Mrtom90\LaravelShop\Html\HtmlBuilder
     */
    protected $html;
     ...
     *
     * @param \Mrtom90\LaravelShop\Html\HtmlBuilder|HtmlBuilder $html
     ...
     * @internal param string $begin
     * @internal param string $end
