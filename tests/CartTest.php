...
class CartTest extends TestCase
{
    ...
    /**
     * @var Mrtom90\LaravelShop\Cart\Cart
     */
    protected $cart;
    ...
    public function test_cart_update_with_attribute_then_attributes_should_be_still_instance_of_ItemAttributeCollection()
    {
        ...
        $this->assertInstanceOf('Mrtom90\LaravelShop\Cart\ItemAttributeCollection', $item->attributes);
    ...
    {
        $this->setExpectedException('Mrtom90\LaravelShop\Cart\Exceptions\InvalidItemException');
